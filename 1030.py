...
#optimizer = Optimizer_SGD(0.1, 5e-7,0.6)
#optimizer = Optimizer_Adagrad(0.1, 5e-7,0.6)
optimizer = Optimizer_RMSprop(0.1,5e-7,0.6)
#optimizer = Optimizer_Adam(0.1,5e-7,0.6)
